...
public class PostVo {
    ...
    public String toString() {
        return "InsertPostVo{" + "post_id='" + post_id + '\'' + ", user_id='" + user_id + '\'' + ", write_time='"
                + write_time + '\'' + ", eatting_time='" + eatting_time + '\'' + ", fullness=" + fullness
                + ", satisfation=" + satisfation + ", text='" + text + '\'' + ", ctime='" + ctime + '\'' + ", utime='"
                + utime + '\'' + '}';
    }
}
